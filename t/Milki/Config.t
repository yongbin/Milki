...

{
    ...
    like(
        $content,
        qr/\Q; Config file generated by Milki version \E.+/,
        'generated config file includes Milki version'
    );
    ...
    like(
        $content,
        qr/\[Milki\].+?\[antispam\].+?\[database\]/s,
        'section order is alphabetical, except that first section is Milki'
    );
}
