package Milki::Markdent::Dialect::Milki::SpanParser;
...
use Milki::Markdent::Event::FileLink;
use Milki::Markdent::Event::ImageLink;
use Milki::Markdent::Event::WikiLink;
...
sub _match_wiki_link {
    ...
    my $event = $self->_make_event( 'Milki::Markdent::Event::WikiLink' => %p );
...
sub _match_file_link {
    ...
    my $event = $self->_make_event( 'Milki::Markdent::Event::FileLink' => %p );
...
sub _match_image_link {
    ...
    my $event
        = $self->_make_event( 'Milki::Markdent::Event::ImageLink' => %p );
...
# ABSTRACT: Parses span-level markup for the Milki Markdown dialect
