package Milki::Role::Schema::DataValidator;
...
use Milki::Exceptions qw( data_validation_error );

use MooseX::Role::Parameterized;

parameter 'steps' => ( isa => 'ArrayRef[Str]', default => sub { [] }, );

parameter 'validate_on_insert' => ( isa => 'Bool', default => 1, );

parameter 'validate_on_update' => ( isa => 'Bool', default => 1, );
...
sub _needs_value_error {
    ...
    return { field => $name, message => "You must provide $articled." };
}
